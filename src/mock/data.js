...
export const projectsData = [
  {
    ...
    img: 'project9.jpeg',
    title: 'Tech Jobz',
    info: 'Tech Jobz.co is a US client-based Technical job finding an application that included Job posts, Digital CV, interviewing, score Card, etc.',
    info2:
      'Used technologies are Matrial UI, React framework, Next.js, React redux, Mongo DB, SendGrid, PayHere, JWT webtoken, react hooks, Express.js, formik.',
    url: 'https://qa.admin.ictjobs.app/',
  ...
  },
  {
    ...
    img: 'project10.jpeg',
    title: 'LWL System',
    info: 'Life Without Laundry is a US client-based Laundry management system that included pick ups and delivery.',
    info2:
      'Used technologies are Matrial UI, React framework, React redux, Mongo DB, SendGrid, Paypal, JWT webtoken, react hooks, Express.js, formik.',
    url: 'https://www.lifewithoutlaundry.com/',
    repo: 'https://github.com/NimeshMadusanka', // if no repo, the button will not show up
  },
  {
    id: nanoid(),
    img: 'project11.jpeg',
    title: 'Preassessme',
    info: 'Preassessme is a Australian client-based Insurance questionnaire base Applications for advisors to manage their manage their clients and underwriters.',
    info2:
      'Used technologies are Matrial UI, React framework, React redux, Mongo DB, SendGrid, Twilio, Paypal, JWT webtoken, react hooks, Express.js, formik.',
  ...
  },
  {
    ...
    img: 'Capture.PNG',
    title: 'Gottamenu.app',
    info: 'Gottamenu.app is a US client-based food find application that included physical and Digital menus.',
    info2:
      'Used technologies are Matrial UI, React framework, React redux, Mongo DB, SendGrid, Google login, Facebook login JWT webtoken, react hooks, Express.js, formik.',
    url: 'https://gottamenu.app/',
    repo: 'https://github.com/NimeshMadusanka', // if no repo, the button will not show up
  },
  {
    ...
    info: 'Subscription.lk is an online newspaper ordering site in Wijeya newspapers. Users can order newspapers provide relevant details and payments.',
    info2:
      'Used technologies are Boostrap 4, React framework, React redux, Mongo DB, Payment gateway, SendGrid, JWT webtoken, react hooks, Express.js, formik.',
  ...
  },
  {
    ...
    img: 'project8.png',
    title: 'Smart Farmer',
    info: 'Smart Farmer is a mobile application for farmers to selling their harvest and buying Diary Products, wast managed and included consultant services.',
    info2:
